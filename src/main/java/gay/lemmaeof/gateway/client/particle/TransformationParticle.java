...
public class TransformationParticle extends AnimatedParticle {
	public TransformationParticle(ClientWorld world, double x, double y, double z, double velocityX, double velocityY, double velocityZ, SpriteProvider spriteProvider) {
